    ...
    <div>
      <div className="main-container">
        <div className="container1">
          <img src={logo} alt="shaastra-logo" id="shaastra-logo"/><br/>
          <img src={QR} alt="qr" id="qr-code"/>
          <h5><u>Download our Shaastra App now</u></h5>
        </div>
        <div className="container2">
          ...
          <address>
            ...
            IIT Madras, Guindy, Chennai, Tamil Nadu, Chennai - 600036<br/>
          </address>
          </div>
        </div>
        <div className="container3">
          ...
          <h1>Contact us</h1>
          <a href="outeach@shaastra.org">outeach@shaastra.org</a>
          <h6>To lodge a complaint<br/> click below.</h6>
